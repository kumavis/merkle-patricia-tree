var Trie = require('../index.js'),
  ...
  RemoteInterface = require('../remoteInterface.js');
  HostInterface = require('../hostInterface.js');

// var semaphore = require('semaphore')
// sem = semaphore(1)
// var describe = function(desc, test){
//   console.log(desc)
//   test()
// }
// var before = function(desc, test){
//   sem.take(function(){
//     console.log(desc)
//     test(function(){
//       sem.leave()
...
function LinkedTriePair(){
  var remoteTree = new Trie()
  RemoteInterface(remoteTree)
  var remoteStream = remoteTree.createNetworkStream()
  
  var hostTree = new Trie()
  HostInterface(hostTree)
  var hostStream = hostTree.createNetworkStream()

  // hostStream.pipe(remoteStream).pipe(hostStream)
  remoteStream.pipe(hostStream).pipe(remoteStream)
